Here we Wrote a simple bash script that deploys a kind cluster locally. The Kind approcah simply means this cluster is built and enacted locally on your system unlike the Minikube and K3s approach. 
